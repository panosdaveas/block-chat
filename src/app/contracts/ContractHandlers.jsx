...
const path_to_contract = path.join(__dirname, "../src/app/contracts/CallContract.json");
const myContract = fs.readFileSync(path_to_contract);
// import myContract from "../artifacts/src/contracts/tl_ic_gmp.sol/CrossChainMessaging.json" assert { type: "json" };
...
async function userASendsMessage(walletProvider, wallet, sourceContractAddress, data) {
    try {
...
async function userBReadsMessages(walletProvider, wallet, contractAddress) {
    try {
        // Create messenger with the provided wallet and contract address
        const messenger = new CrossChainMessenger(
            walletProvider,
